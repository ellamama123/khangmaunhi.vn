...
@section('content')
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">@if($id==0)Thêm mới @else Sửa @endif đào tạo</li>
                </ul>
            </div>
                                    ...
                                    <div class="nav-tabs-horizontal nav-tabs-inverse" data-plugin="tabs">
                                        ...
                                        <div class="tab-content pt-10">
                                            <div class="tab-pane panelDetail active" id="tabNoiDung" role="tabpanel">
                                                                ...
                                                                @foreach($news_image_other as $k=>$v)
                                                                    <li id="sys_div_img_other_{{$k}}">
                                                                        <div class="div_img_upload">
                                                                            ...
                                                                            <br/>
                                                                            <a href="javascript:void(0);" id="sys_delete_img_other_{{$k}}" onclick="UploadAdmin.removeImage('{{$k}}', '{{$data['statics_id']}}', '{{$v['img_other']}}', '7');">Xóa ảnh</a>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Bảng giá dịch vụ</label>
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="statics_note">@if(isset($data['statics_note'])){{stripslashes($data['statics_note'])}}@endif</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="statics_note_2">@if(isset($data['statics_note_2'])){{stripslashes($data['statics_note_2'])}}@endif</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm" name="statics_num" value="@if(isset($data['statics_num'])){{$data['statics_num']}}@endif">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm formatMoney" name="statics_price_normal" value="@if(isset($data['statics_price_normal'])){{$data['statics_price_normal']}}@endif" min="0" max="50000000" autocomplete="off" data-v-max="50000000" data-v-min="0" data-a-sep="." data-a-dec="," data-a-sign=" đ" data-p-sign="s">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Giá sau giảm</label>
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm formatMoney" name="statics_price_discount" value="@if(isset($data['statics_price_discount'])){{$data['statics_price_discount']}}@endif" min="0" max="50000000" autocomplete="off" data-v-max="50000000" data-v-min="0" data-a-sep="." data-a-dec="," data-a-sign=" đ" data-p-sign="s">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm" name="statics_time" value="@if(isset($data['statics_time'])){{$data['statics_time']}}@endif">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm date" name="statics_date_start" @if(isset($data['statics_date_start']) && $data['statics_date_start'] > 0)value="{{date('d-m-Y', $data['statics_date_start'])}}"@endif>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm" name="statics_teacher" value="@if(isset($data['statics_teacher'])){{$data['statics_teacher']}}@endif">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Địa điểm hoc</label>
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm" name="statics_address" value="@if(isset($data['statics_address'])){{$data['statics_address']}}@endif">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
    ...
    <script>
        ...
        CKEDITOR.replace('statics_note');
        CKEDITOR.replace('statics_note_2');
        //Keo Tha Anh
