...
class Banner extends Model{
    ...
    protected $table = CDatabase::banner;
	...
	public static function removeCacheId($id=0){
		...
		Cache::forget(Memcache::CACHE_BANNER_SITE.'head');
		Cache::forget(Memcache::CACHE_BANNER_SITE.'sLeft');
		Cache::forget(Memcache::CACHE_BANNER_SITE.'sRight');
		Cache::forget(Memcache::CACHE_BANNER_SITE.'partners');
    }
