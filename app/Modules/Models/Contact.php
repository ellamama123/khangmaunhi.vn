...
class Contact extends Model {
    ...
    protected $fillable = array(
	    		...
	    		'contact_content', 'contact_type', 'contact_created', 'contact_status');
    ...
    public static function searchByCondition($dataSearch=array(), $limit=0, $offset=0, &$total){
    	try{
			...
			if (isset($dataSearch['contact_type']) && $dataSearch['contact_type'] != -1) {
				$query->where('contact_type', $dataSearch['contact_type']);
			}
